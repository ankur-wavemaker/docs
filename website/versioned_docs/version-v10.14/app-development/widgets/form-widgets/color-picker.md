...
<iframe width="100%" height="200" style={{backgroundColor:'snow'}} allowtransparency="true" src="https://apps-platform.wavemaker.ai/wm-platform-apps/documentation_snippets/#/ColorPicker">Color Picker</iframe>
