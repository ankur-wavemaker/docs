---
title: "Transition from WaveMaker Online to WaveMaker.ai"
...
- **If you have deployed applications:**
  ...
  Please note that deployed application URLs have changed from **cloud.wavemakeronline.com** to **apps-platform.wavemaker.ai**. 
  So, you will need to update any references to the old URL accordingly.
